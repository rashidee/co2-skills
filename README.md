...
| util-preparek8senv | /util-preparek8senv        | K8s Infrastructure Preparation                   | Generates K8s StatefulSet manifests for all 3rd party supporting applications across all environments. Creates/updates ENVIRONMENT.md with per-environment configs. Output in environment/\<env\>/ folders.                                                                                                                                                                                   |
...
~~~bash
/util-preparek8senv ## Generates K8s manifests for all 3rd party apps across all environments
~~~
...
- <project_folder>
  ...
  - environment
    - <environment_1> (K8s manifests for 3rd party apps — generated by util-preparek8senv)
    - <environment_2>

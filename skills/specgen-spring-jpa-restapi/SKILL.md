...
credentials to use in the spec's application configuration. Read `LOCAL.md` (in the
...
scheduling config (if selected), and logging configuration. **All environment-sensitive

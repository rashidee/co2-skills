...
- The project folder structure is as follows:
  ...
  - skills: Folder containing Claude skills for compound-context methodology
    ...
    - util-projectsync: Validates dependencies and deployment environments, then syncs project folder structure, PRD.md, BUG.md, and deployment SECRET.md files (deployment/<env>/SECRET.md) based on applications and modules defined in CLAUDE.md. (Prerequisite: CLAUDE.md)
